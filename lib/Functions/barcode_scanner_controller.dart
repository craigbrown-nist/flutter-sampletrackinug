...
class MobileScannerPicklist extends StatefulWidget {
  ...
  const MobileScannerPicklist({super.key, required this.single});
  final int single;
...
class _MobileScannerPicklistState extends State<MobileScannerPicklist> {
  ...
  late String bar; // return this if Single = 1 it could be an integer (sample) or a string (cell) - deal with it in the calling function
  late List<String>  bars; // return this if Single = 0 - it will always be a sample barcode i.e. an integer
