          ...
          child: Column(
            ...
            children: <Widget>[
              FormBuilderTextField(
                name: "name",
                decoration: InputDecoration(labelText: "Name",  suffixIcon:  Icon(MdiIcons.pirate)),
                validator: FormBuilderValidators.compose([FormBuilderValidators.required()]),
              ),
              FormBuilderTextField(
                name: "email",
                decoration:  InputDecoration(labelText: "Email", icon: Icon(MdiIcons.email)),
              ...
              FormBuilderTextField(
                name: "password",
                decoration:  InputDecoration(labelText: "Password (optional)", icon: Icon(MdiIcons.key)),
              ),
              FormBuilderTextField(
                name: "address",
                decoration:  InputDecoration(labelText: "Address", icon: Icon(MdiIcons.city)),
              ),
              ...
              FormBuilderSwitch(
                ...
                name: "manager",
                initialValue: false,
                decoration:  InputDecoration(icon: Icon(MdiIcons.cardAccountDetailsStar, color: Colors.grey)),
              ),
