...
// The old functions are now deprecated and replaced by the AppDrawer widget.
// We keep them for now to avoid breaking all the pages that use them at once.
// They will now just return the new AppDrawer widget.

@Deprecated('Use AppDrawer widget instead')
Drawer adminNavDrawer(BuildContext context) {
  return const AppDrawer();
}

@Deprecated('Use AppDrawer widget instead')
Drawer userNavDrawer(BuildContext.context) {
  return const AppDrawer();
}
